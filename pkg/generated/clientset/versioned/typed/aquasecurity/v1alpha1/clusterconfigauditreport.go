...
type ClusterConfigAuditReportInterface interface {
	...
	Apply(ctx context.Context, clusterConfigAuditReport *aquasecurityv1alpha1.ClusterConfigAuditReportApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterConfigAuditReport, err error)
...
func (c *clusterConfigAuditReports) Apply(ctx context.Context, clusterConfigAuditReport *aquasecurityv1alpha1.ClusterConfigAuditReportApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterConfigAuditReport, err error) {
